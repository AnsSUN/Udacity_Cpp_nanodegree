...
void RoutePlanner::AddNeighbors(RouteModel::Node *current_node) {
    ...
    for(auto i:current_node->neighbors){
        ...
        i->visited = true;
        RoutePlanner::open_list.push_back(i);
    }
}
...
RouteModel::Node *RoutePlanner::NextNode() {
    ...
    RouteModel::Node *lsum_node = open_list.back();
    open_list.pop_back();
    return lsum_node;
}
...
void RoutePlanner::AStarSearch() {
    ...
    // TODO: Implement your solution here.
	std::vector<RouteModel::Node> pathmap;
  	...
  	while(open_list.size()>0){
    	...
    	if(current_node == end_node) {
          pathmap = ConstructFinalPath(current_node);
          m_Model.path = pathmap;
          break;
        }
  	}
}